...
class Library {
    ...
    fun showBooks() : List<Book>? { // ? because there is a chance there are no books
    ...
    --- Library Catalog ---
    Title: Kotlin in Action, Author: Dmitry Jemerov, Era: Contemporary, Available: 5 copie
